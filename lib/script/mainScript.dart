...
class MainScript extends StatefulWidget {
  const MainScript({Key? key}) : super(key: key);

  @override
  _MainScriptState createState() => _MainScriptState();
}

class _MainScriptState extends State<MainScript> {
  @override
